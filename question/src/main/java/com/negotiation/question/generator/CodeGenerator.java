package com.negotiation.question.generator;
...
public class CodeGenerator {
    private static final DataSourceConfig DATA_SOURCE_CONFIG = new DataSourceConfig		// 配置数据源
            .Builder("jdbc:p6spy:mysql://localhost:3306/negotiation?serverTimeZone=UTC&useUnicode=true&characterEncoding=UTF-8",
            "root", "admin")
            .schema("negotiation")
            .build();
    ...
    private static final PackageConfig PACKAGE_CONFIG = new PackageConfig.Builder()		// 配置包文件
            .moduleName("question")			// 包名称
            .parent("com.negotiation")			// 父目录名称
